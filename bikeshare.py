...
def station_stats(df):
    ...
    print("{} to {} is the most frequent combination of start station and end station destination".format(
...
def trip_duration_stats(df):
    ...
    print("The mean traveltime is {}".format(df["Trip Duration"].mean()))
